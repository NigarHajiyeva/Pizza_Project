...
class main:
    ...
    def widgets(self):
       ...
       # self.b1.pack_forget()
        ...
        self.b4.pack_forget()
        self.b5=Button(self.master,text="remove",bg='cyan',bd=3,width=15,font=('',15),command=lambda:self.add_remove(self.pizza,"Tomato","remove"))
        self.b5.pack_forget()
        self.b6=Button(self.master,text="remove",bg='cyan',bd=3,width=15,font=('',15),command=lambda:self.add_remove(self.pizza,"Cheese","remove"))
        self.b6.pack_forget()
